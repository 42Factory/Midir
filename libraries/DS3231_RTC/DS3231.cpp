/*
  DS3231.cpp - Arduino/chipKit library support for the DS3231 I2C Real-TimeRTC Clock
...
void DS3231::setTimeRTC(uint8_t hour, uint8_t min, uint8_t sec)
{
...
char *DS3231::getTimeRTCStr(uint8_t format)
{
...
long DS3231::getUnixTimeRTC(TimeRTC t)
{
	uint16_t	dc;
